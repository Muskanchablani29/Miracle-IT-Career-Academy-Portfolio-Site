...
import { 
  FaClock, FaBriefcase, FaCertificate, FaBook, FaChevronDown, FaChevronUp, 
  FaLock, FaPlay, FaUsers, FaStar, FaGraduationCap, FaInfinity, FaMobile,
  FaDownload, FaTrophy, FaCheckCircle, FaRupeeSign
} from 'react-icons/fa';
